...
public class Vector2D {
   ...
   * 
   * If two vectors (A-> and B-> ) are orthogonal (i.e. perpendicular), the dot product (A-> *B-> )
   * is equal to 0.
   * 
   * If two vectors are unit vectors, then the dot product is simply equal to cosine of the angle
   * between them, i.e. A-> * B-> = cos() if A-> and B-> are of length 1.
   */
